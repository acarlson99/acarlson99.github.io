...
#+NAME: sin-gradient
#+BEGIN_SRC glsl :file ./static/shadergen/sin-gradient.png :width 1000 :height 200 :exports both
  #define PI 3.14159
...
#+BEGIN_SRC glsl :file ./static/shadergen/square-gradient.png :width 1000 :height 200 :exports both
  #define PI 355./113.
  void main() {
      vec2 uv = (gl_FragCoord.xy - .5*iResolution.xy) / iResolution.xy;
...
#+BEGIN_SRC glsl :file ./static/shadergen/triangle-gradient.png :width 1000 :height 200 :exports both
  #define PI 3.14159
...
#+BEGIN_SRC glsl :file ./static/shadergen/sawtooth-gradient.png :width 1000 :height 200 :exports both
  #define PI 3.14159
...
#+NAME: checkerboard-2
#+BEGIN_SRC glsl :file ./static/shadergen/checkerboard-2.png :width 1080 :height (/ 1080 2) :exports both :noweb no-export :noweb-prefix no
  #define N 2.0
  // <<checkerboard-1>>
#+END_SRC
...
#+NAME: checkerboard-3
#+BEGIN_SRC glsl :file ./static/shadergen/checkerboard-3.png :width 1080 :height (/ 1080 2) :exports both :noweb no-export :noweb-prefix no
  #define N 3.0
  // <<checkerboard-1>>
#+END_SRC
...
**** lch hsv gradient throbs and pulses

...
#+NAME: color-mix
#+BEGIN_SRC glsl :file ./static/shadergen/color-mix-shader-out.png :width (/ 1080 2) :height (/ 1080 6) :exports both :noweb no-export :noweb-prefix no
  // <<hsv-conversion-fns>>
  // <<srgb-conversion-fns>>
  // <<oklab-conversion-fns>>
  // <<oklch-conversion-fns>>
...
#+BEGIN_SRC glsl :file ./static/shadergen/color-mix-shader-out-skibidi.png :width (/ 1080 2) :height (/ 1080 6) :exports results :noweb no-export :noweb-prefix no
  #define MODE 1
  // <<color-mix>>
#+END_SRC
